...
Наш репозиторий [CachyOS-PKGBUILDs](https://github.com/CachyOS/CachyOS-PKGBUILDS) содержит пакеты, которые получают постоянные обновления, патчи и исправления, перенесённые из новых версий.
