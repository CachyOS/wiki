...
:::tip
Прежде чем рассматривать возможность добавления наших репозиториев, пожалуйста, ознакомьтесь со **[списком совместимости CPU](/ru/installation/installation_prepare#x86_64-microarchitecture-level-support)**
:::
