...
Для каждого из ядер существует [соответствующий вариант `-lto`](#package-naming-convention), который
...
Поэтому на данный момент он присутствует только в варианте [linux-cachyos](/ru/features/kernel#linux-cachyos-default-kernel).
