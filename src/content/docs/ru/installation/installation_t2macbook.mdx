...
Для продолжения установки требуется интернет, поэтому используйте либо LAN-сеть, либо следуйте [этому разделу](#getting-wifi-firmware-for-the-installation), чтобы получить прошивку WiFi.
...
CachyOS применяет необходимые параметры загрузки и конфигурации к T2 MacBook пользователя с помощью [Обнаружение оборудования CachyOS](/features/chwd).
