...
- Увеличен таймаут проверки соединения в разделе утилит для учёта возможных задержек сети или медленных ответов.
...
- Включена библиотека CPR для сборок, не относящихся к среде разработки.
