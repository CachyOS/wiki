...
3. Выполните следующую команду:
   ...
   ```
4. Сравните вывод хеша certUtil с хешем из загруженного файла в **Шаге 1.** Если они совпадают, вы можете продолжить установку CachyOS.
...
2. Откройте терминал и перейдите в каталог, содержащий файл `.sha256`, и выполните следующие команды:
   ...
   ```
3. Сравните вывод из **Шага 2** и выполните следующую команду, чтобы проверить текущий хеш в ISO-файле.
   ```sh
   # Пример:
