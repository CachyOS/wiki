...
Если вы хотите поддержать нашу работу, вы можете сделать пожертвование и помочь нам оплачивать серверы для сборки.
Каждый, кто пожертвует, получит ранг Donator в нашем Discord.

Вот список текущих ежемесячных расходов:

- Сервер для сборки 127 € (Hetzner 7950X3D)
- Второй сервер для сборки 70 € (Hetzner 7700X)
