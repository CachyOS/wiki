...
**Новые возможности:**
- **occt**: Добавлен OCCT в ISO для возможности стресс-тестирования в live-режиме
  - Спасибо Мареку за идею!

**Исправления:**
- **kernel**: Исправлен сбой модуля на ноутбуках Asus
- **limine**: Теперь в Limine установлен mkinitcpio-limine-hook, который автоматически создаёт записи загрузчика

**Изменения в Handheld Edition:**
- **audio**: Добавлены аудиопрофили для ROG Ally X и Legion Go
- **gamescope**: gamescope-plus заменён на основную версию gamescope
