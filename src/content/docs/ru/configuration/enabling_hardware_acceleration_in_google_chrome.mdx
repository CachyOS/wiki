...
* **nvtop:** (только для ГП Intel) Установите `nvtop` (Lunar Lake) и `intel-gpu-tools` (до Lunar Lake) через менеджер пакетов octopi, если вы хотите отслеживать активность ГП Intel через терминал.
