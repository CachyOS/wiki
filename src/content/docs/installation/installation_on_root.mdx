...
:::danger[Secure boot must be disabled when installing CachyOS]
To setup secure boot after installation check: **[Secure Boot Setup.](/configuration/secure_boot_setup)**
:::
