...
3.  **Run the CachyOS Installer:**
    ...
    *   Follow the standard installation procedure, refer the [Installation on Desktop Edition Guide](/installation/installation_on_root).
    *   When partitioning, select the free space created earlier. Let the installer handle formatting.
        ...
        :::
    *   CachyOS Hardware Detection ([chwd](/features/chwd/chwd)) should automatically apply necessary T2-specific boot parameters and configurations during installation.
