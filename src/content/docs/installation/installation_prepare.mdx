...
`dd` command will now copy the contents of the ISO file over to your USB drive. Once done, you’re ready to use the USB drive as CachyOS installation media. Reboot the system for booting into CachyOS.
:::note
Be sure to have the USB drive **boot priority** over other drives in the BIOS.
:::
