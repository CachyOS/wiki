...
<Aside type="tip" title="Getting ready for CachyOS.">
  The following section will guide you through the steps to prepare your USB
  drive with CachyOS ISO image for installation and the necessary requirements.
</Aside>
