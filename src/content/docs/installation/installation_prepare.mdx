...
Before beginning with installation preparations, make sure that the computer used meets the necessary system requirements in order to run CachyOS. The installer
...
4. Select the plugged USB drive by clicking on **`Device`.**
5. Click on **`Install`.**
6. After it finished installing Ventoy into the plugged USB drive, close the window and place the CachyOS ISO file into the new usable partition of the drive.
</Steps>
