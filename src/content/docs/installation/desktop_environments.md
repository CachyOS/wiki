...
9. **Hyprland:** a visually pleasing Wayland compositor that uses dynamic tiling. It comes with pre-configured [dotfiles](https://github.com/CachyOS/cachyos-hyprland-settings). **`Unstable on certain hardware configurations`**.
