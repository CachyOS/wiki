...
The Handheld Edition is using the `systemd-boot` as bootloader, and there is no bootloader selection available, as it available on the default CachyOS Edition.
