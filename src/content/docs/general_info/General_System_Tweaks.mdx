...
To make the changes persistent, add `zswap.compressor=zstd zswap.max_pool_percent=10` to your bootloader's kernel command line options
...
*   rEFIndL `/boot/refind_linux.conf`
