...
### How to set custom Proton versions for Steam games and general recommendations
:::note
It's STRONGLY RECOMMENDED to keep Valve's Proton as the global default.
To set Valve's Proton in global default, navigate to Settings > Compatibility > Default Compatibility tool
and set the latest stable release of Valve's proton
:::
