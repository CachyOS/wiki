...
For more experienced users, the following custom Proton builds can be considered for use. Keep in mind that they are not officially supported by Valve, and may have issues with certain games.

Third Party Proton forks (Advanced):

**Proton-CachyOS:**
Built and maintained by [CachyOS](https://github.com/CachyOS/proton-cachyos). Using it over Proton Experimental is recommended **only** if you want the extra quality-of-life features and fixes.
...
**Proton-EM:**
A development oriented custom build made by [Etaash-mathamsetty](https://github.com/Etaash-mathamsetty/Proton). It is a very good option if you want to use **winewayland** and **FSR4** without any of the extras **Proton-CachyOS** offers. It is also the source of various improvements that Proton-CachyOS also includes.
