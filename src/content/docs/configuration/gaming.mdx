...
Links to Proton-CachyOS documents: [Readme](https://github.com/CachyOS/proton-cachyos/blob/cachyos_main/README.md#proton-cachyos-config-options), [Changelog](https://github.com/CachyOS/proton-cachyos/blob/cachyos_main/CHANGELOG.md)
Links to Proton-EM documents: [Readme](https://github.com/Etaash-mathamsetty/Proton/blob/em-11-hdr/README.md), Other links for Proton-EM 10 [1](https://github.com/Etaash-mathamsetty/Proton/blob/em-10-hdrtest/docs/EM-ADDITIONS.md), [2](https://github.com/Etaash-mathamsetty/Proton/blob/em-10-hdrtest/docs/FSR4.md), [3](https://github.com/Etaash-mathamsetty/Proton/blob/em-10-hdrtest/docs/CHANGES.md)
:::
...
- HDR Support
    - `DXVK_HDR=1`: Enable HDR output support.
      - Users of NVIDIA drivers **before** 595.58.03 will also need to install `vk-hdr-layer-kwin6-git` and set `ENABLE_HDR_WSI=1`
