...
* Add this in **Steam → Properties → Launch Options**.
* Logs are saved in your **home directory** as `steam-<AppID>.log`.
...
After capturing a log, you can find it in your home directory (or in the directory you specified).
...
offers similar functionality, but should not be used since CachyOS already ships with [ananicy-cpp](https://gitlab.com/ananicy-cpp/ananicy-cpp)
