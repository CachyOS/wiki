...
Open CachyOs Hello app.  In Apps/Tweaks, click Install Snapper support, this will trigger create / and /home snapshots.   
Detail config can modified by Btrfs Assistant.    
