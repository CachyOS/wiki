...
1. Create a backup of your current configuration files in your home directory:
    ...
    ```
2. Uninstall the current `-settings` package if you have one installed. For example, if you are using i3wm, run:
    ```bash
    sudo pacman -R cachyos-i3wm-settings
    ```
    :::note
...
- [Xfce - Discontinued](https://github.com/CachyOS/cachyos-xfce-settings)
- [Niri](https://github.com/CachyOS/cachyos-niri-settings)
- [Hyprland](https://github.com/CachyOS/cachyos-hyprland-settings)
- [i3](https://github.com/CachyOS/cachyos-i3wm-settings)
- [Qtile](https://github.com/CachyOS/cachyos-qtile-settings)
- [Openbox](https://github.com/CachyOS/cachyos-openbox-settings)
