...
| Description | Key |
|-------------|-----|
| Switch to monitor | <Kbd linux="Super+#" /> |
...
> _"Why doesn't my clipboard history persist through reboots?"_
...
> _"Why are some theming options (Dolphin icons, some QT elements, etc.) not working?"_
