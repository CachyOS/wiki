...
### What are the reasons behind deprecating Hyprland?

Due to the burden of maintaining against the constant upstream changes breaking the configuration + lack of a dedicated maintainer, we have decided to deprecate Hyprland as an official desktop choice.
