...
"Preferences" button). Next, go to _"Global Options"_ -> _"Display"_. Here, you can select the GPU the game will run on.
...
application menu then go to _"Properties"_ -> _"Application"_ -> _"Advanced Options"_.
