...
After enabling config checksum enrollment and generating the hash for the splash image, run the following command to enroll the config checksum and sign Limine's EFI binary:
