...
Above shows all the files that need to be signed in order for secure boot to work.
This includes all the linux kernel images you have installed and the boot loader you are using.
Simply sign all the files that are listed in the above command.

```bash
❯ sudo sbctl sign -s /boot/1c4b5246eef05ac3bc87339323cd5101/6.10.0-cn4.0.fc40.x86_64/linux
