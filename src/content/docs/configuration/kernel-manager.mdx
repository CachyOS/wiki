...
The Kernel Manager does also offer a GUI for managing and controlling the sched-ext schedulers.
You can switch between different scx scheduler, enable the service and also see, which scheduler is currently running.
