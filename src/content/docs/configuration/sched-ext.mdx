...
**Use scx_schedulername --help to see the available flags for each scheduler.**
- Example:
...
:::note[Credits]
Some of the links below were originally referenced from the [sched-ext GitHub repository](https://github.com/sched-ext/sched-ext#readme).
