...
<Steps>
    ...
    2. Enable Zswap by adding the following kernel parameter:
        ...
        ```
    3. Create an empty override file to disable [CachyOS's udev rule](https://github.com/CachyOS/CachyOS-Settings/blob/master/usr/lib/udev/rules.d/30-zram.rules) which disables Zram:
        ```bash
