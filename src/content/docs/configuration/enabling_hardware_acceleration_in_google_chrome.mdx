...
### Vivaldi - NVIDIA RTX 5070Ti (Contributed by Peek4Boo7)
...
**Notes:**
- Driver: NVIDIA 615.71.09, libva-nvidia-driver 0.0.18-1.1
- Vivaldi version: 8.2.4133.52 (Official Build) (x86_64)
- Confirmed via vainfo (driver: VA-API NVDEC driver [direct backend]) and nvidia-smi dmon
- VaapiVideoDecoder and VaapiIgnoreDriverChecks not required at this driver version
- AV1 confirmed working: DevTools Media panel shows Decoder name: VaapiVideoDecoder during AV1 playback (av01 codec)
- AV1 profile listed as supported in vainfo (VAProfileAV1Profile0)
