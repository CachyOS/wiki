...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/251209/cachyos-desktop-linux-251209.iso.sha256) obsahujúci SHA256 hash **(Otvorte ho pomocou textového editora, napr.: Poznámkový blok).**
...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/251209/cachyos-desktop-linux-251209.iso.sha256) obsahujúci SHA256 hash.
