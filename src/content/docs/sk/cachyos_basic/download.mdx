...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/260308/cachyos-desktop-linux-260308.iso.sha256) obsahujúci SHA256 hash **(Otvorte ho pomocou textového editora, napr.: Poznámkový blok).**
...
1. Stiahnite si [súbor](https://mirror.cachyos.org/ISO/desktop/260308/cachyos-desktop-linux-260308.iso.sha256) obsahujúci SHA256 hash.
