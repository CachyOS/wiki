---
Titre: Téléchargements et validation
Description: Téléchargements et validation de CachyOS ISO.
---

import { Steps } from '@astrojs/starlight/components';

CachyOS peut  être installé de deux maniéres: Avec un installeur graphique ou par interface en ligne de commande.
...
Verification depuis ni'mporte quelle distribution Linux:
...
## Verifier l'authenticité de l'image ISO
