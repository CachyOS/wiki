...
:::note[En cas de suppression de la partition /boot. Veuillez en créer une nouvelle en suivant le [schéma de partitionnement](/fr/installation/installation_on_root#uefigpt) respectif à partir de l'étape 5.]
:::
