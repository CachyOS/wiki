...
2. Choisissez le **Chargeur de démarrage** que vous souhaitez utiliser, consultez également l'entrée Wiki [Gestionnaire de démarrage](https://wiki.cachyos.org/installation/boot_managers)
