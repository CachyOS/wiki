...
12. Cliquez sur `Fermer` pour enregistrer les paramètres matériels. Vous verrez maintenant le résumé des paramètres de la machine virtuelle. Décochez l'option
