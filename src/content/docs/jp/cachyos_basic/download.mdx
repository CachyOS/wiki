...
1. Lade die [Datei](https://mirror.cachyos.org/ISO/desktop/250422/cachyos-desktop-linux-250422.iso.sha256) herunter, die den SHA256-Hash enthält **(Öffne sie mit einem Texteditor, z. B. Notepad).**
...
1. Lade die [Datei](https://mirror.cachyos.org/ISO/desktop/250422/cachyos-desktop-linux-250422.iso.sha256) herunter, die den SHA256-Hash enthält.
