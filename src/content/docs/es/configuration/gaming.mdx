...
:::note[NTSync está activado por defecto]
Puedes desactivarlo configurando la variable de entorno PROTON_NO_NTSYNC=1
:::
...
- Rendimiento CPU & Sync
      - PROTON_NO_NTSYNC=1: Usar FSync en lugar de  NTSync.
             - Beneficios: Posibilidad de resolver problemas en ciertos juegos que no funcionan bien con NTSync.
