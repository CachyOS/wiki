...
A diferencia de [systemd-boot](/es/configuration/boot_manager_configuration#systemd-boot) y [rEFInd](/configuration/boot_manager_configuration#refind),
...
### Instantáneas BTRFS Arrancables

:::note
Si tu instalación de CachyOS es anterior a la versión de agosto, es posible que necesites habilitar manualmente la función de instantáneas BTRFS arrancables.

De lo contrario, puedes omitir esta sección, ya que ha sido habilitada por defecto desde la versión de agosto.
:::
...
* **Fonts:** Usa un [archivo de fuente personalizado](https://github.com/viler-int10h/vga-text-mode-fonts) y ajusta su tamaño.
