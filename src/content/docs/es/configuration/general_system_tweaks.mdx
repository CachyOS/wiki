...
<Steps>
    ...
    2. Habilita Zswap añadiendo el siguiente parámetro del kernel:
        ...
        ```
    3. Crea un archivo de override vacío para deshabilitar [la regla udev de CachyOS](https://github.com/CachyOS/CachyOS-Settings/blob/master/usr/lib/udev/rules.d/30-zram.rules) que deshabilita Zram:
        ```bash
