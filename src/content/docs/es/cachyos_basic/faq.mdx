...
:::note[En caso de una partición /boot eliminada. Por favor, crea una nueva siguiendo el [esquema de particiones](/es/installation/installation_on_root#uefigpt) respectivo desde el paso 5.]
:::
