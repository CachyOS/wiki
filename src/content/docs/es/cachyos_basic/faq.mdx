...
Útil para casos en los que las entradas del gestor de arranque desaparezcan después de una actualización de BIOS, o simplemente por si necesitases hacerlo.
