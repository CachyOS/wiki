...
El repositorio de CachyOS está diseñado para proporcionar paquetes optimizados y de alta calidad para los usuarios de las distribuciones CachyOS y ArchLinux. Esta política describe los términos y condiciones para el uso del repositorio de CachyOS.

## 2. Exclusión de Garantía

A menos que lo exija la ley aplicable o se acuerde por escrito, el equipo de CachyOS proporciona el repositorio **"TAL CUAL", SIN GARANTÍAS NI CONDICIONES DE NINGÚN TIPO**, ya sean expresas o implícitas, incluyendo, sin limitación,
cualquier garantía o condición de **TÍTULO, NO INFRACCIÓN, COMERCIABILIDAD o IDONEIDAD PARA UN PROPÓSITO PARTICULAR**. Usted, como usuario del repositorio, es el único responsable de determinar la idoneidad del uso del repositorio y asume
todos los riesgos asociados con el ejercicio de sus permisos.

## 3. Limitación de Responsabilidad

En ningún caso y bajo ninguna teoría legal, ya sea por agravio (incluida la negligencia), contrato o de otro modo, a menos que lo exija la ley aplicable (como actos deliberados y de negligencia grave) o se acuerde por escrito, el equipo de CachyOS
será responsable ante los usuarios del repositorio por daños, incluidos cualesquiera daños directos, indirectos, especiales, incidentales o consecuentes de cualquier tipo que surjan como resultado de esta política o del uso o la incapacidad de usar el repositorio
(incluyendo, pero no limitado a, daños por pérdida de fondo de comercio, interrupción del trabajo, fallo o mal funcionamiento del ordenador, o cualquier otro daño o pérdida comercial), incluso si el equipo de CachyOS ha sido advertido de la posibilidad de tales daños.

## 4. Usuarios Soportados

El repositorio de CachyOS (y sus réplicas) ofrece soporte exclusivamente a los siguientes usuarios:

- Usuarios de CachyOS
- Usuarios de ArchLinux

## 5. Usuarios No Soportados

Los usuarios de otras distribuciones **NO ESTÁN SOPORTADOS** y se **DESACONSEJA ENCARECIDAMENTE** el uso del repositorio de CachyOS (y sus réplicas). Esto incluye, entre otras:
...
(y sus réplicas) por sus propios medios. Los usuarios finales y las réplicas de terceros no están sujetos a la política de redistribución.
