...
- `game-performance` - Skrypt otaczający **`powerprofilesctl`**, aby na żądanie przełączyć się na profil wydajności. Zobacz [Przełączanie profilu zasilania na żądanie](/pl/configuration/gaming#przełączanie-profilu-zasilania-na-żądanie)
