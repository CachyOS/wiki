...
:::note
Sterownik AMD P-State EPP jest używany domyślnie, jeśli nie dokonano jawnej konfiguracji.
:::
...
Aby ustawić preferencję, uruchom następujące polecenie z żądaną preferencją:
