...
<Steps>
    ...
    4. Przebuduj swój initramfs, aby zastosować zmiany. Polecenie różni się w zależności od bootloadera:
        <details>
    ...
    5. Uruchom ponownie system, aby zastosować wszystkie zmiany.
</Steps>
