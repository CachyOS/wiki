...
<Steps>
    1. Wyłącz ZRam, dodając parametr jądra. [Edytuj konfigurację swojego bootloadera](/pl/configuration/boot_manager_configuration) i dodaj następującą linię:
        ...
        systemd.zram=0
        ```
    2. Utwórz pusty plik nadpisujący, aby wyłączyć [regułę udev CachyOS](https://github.com/CachyOS/CachyOS-Settings/blob/master/usr/lib/udev/rules.d/30-zram.rules), która wyłącza Zram:
        ```bash
