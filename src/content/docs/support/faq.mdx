...
#### Packages not found but should exist

If a mirror is out-of-date, it might not have the latest packages yet. This is different from 404 errors (which usually mean your local database is outdated and needs `pacman -Syu`). In the case of out-of-date mirrors, refreshing your mirror list can help:
