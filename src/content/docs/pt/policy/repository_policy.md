...
O repositório CachyOS foi concebido para fornecer pacotes de alta qualidade e otimizados para utilizadores das distribuições CachyOS e Arch Linux. Esta política descreve os termos e condições para a utilização do repositório CachyOS.

## 2. Exclusão de Garantia

Salvo quando exigido pela lei aplicável ou acordado por escrito, a equipa do CachyOS fornece o repositório **"TAL COMO ESTÁ" (AS IS), SEM GARANTIAS OU CONDIÇÕES DE QUALQUER TIPO**, expressas ou implícitas, incluindo, sem limitação, quaisquer garantias ou condições de **TÍTULO, NÃO INFRAÇÃO, COMERCIALIZAÇÃO ou ADEQUAÇÃO A UM FIM ESPECÍFICO**. Você, como utilizador do repositório, é o único responsável por determinar a adequação da utilização do mesmo e assume quaisquer riscos associados ao exercício das permissões concedidas.

## 3. Limitação de Responsabilidade

Em circunstância alguma e sob nenhuma teoria jurídica, seja por ato ilícito (incluindo negligência), contrato ou outra, a menos que exigido pela lei aplicável (como atos deliberados e de negligência grave) ou acordado por escrito, a equipa do CachyOS será responsável perante os utilizadores do repositório por danos, incluindo quaisquer danos diretos, indiretos, especiais, incidentais ou consequentes de qualquer natureza decorrentes desta política ou resultantes da utilização ou incapacidade de utilizar o repositório (incluindo, mas não se limitando a, danos por perda de prestígio/goodwill, interrupção de trabalho, falha ou mau funcionamento do computador, ou quaisquer outros danos ou perdas comerciais), mesmo que a equipa do CachyOS tenha sido avisada da possibilidade de tais danos.

## 4. Utilizadores Suportados

O repositório CachyOS (e os seus mirrors/espelhos) fornece suporte exclusivamente para os seguintes utilizadores:

- Utilizadores de CachyOS
- Utilizadores de Arch Linux

## 5. Utilizadores Não Suportados

A utilização do repositório CachyOS (e dos seus mirrors) por utilizadores de outras distribuições **NÃO É SUPORTADA** e é **FORTEMENTE DESACONSELHADA**. Isto inclui, mas não se limita a:
