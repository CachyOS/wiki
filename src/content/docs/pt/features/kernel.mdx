...
Não, não melhora. O kernel "realtime" (tempo real) torna muito mais código passível de preempção em comparação com um kernel normal totalmente preemptivo. Isto significa que muito mais tarefas (incluindo os processos dos jogos) sofrem preempção frequente e cedem forçosamente os recursos do sistema, o que leva a um desempenho inferior.
