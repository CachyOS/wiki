...
<Steps>
    ...
    2. Ative o Zswap adicionando o seguinte parâmetro ao kernel:
        ...
        ```
    3. Crie um ficheiro de sobreposição (override) vazio para desativar a [regra udev do CachyOS](https://github.com/CachyOS/CachyOS-Settings/blob/master/usr/lib/udev/rules.d/30-zram.rules) que desativa o Zram:
        ```bash
