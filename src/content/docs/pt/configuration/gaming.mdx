...
<Tabs>
	...
	- Abre o CachyOS Hello. Vai a **Apps/Tweaks** e clica em `Install Gaming packages`.
...
:::note[O NTSync está ativado por predefinição]
Podes desativá-lo definindo a variável de ambiente `PROTON_USE_NTSYNC=0`
:::
...
:::note[Este passo só é necessário se o pacote cachyos-gaming-meta não tiver sido instalado. Se foi instalado, ignora esta parte.]
:::
...
<Steps>
    1. Abre um terminal e instala o `protonup`.
        ```sh
        sudo pacman -S protonup-qt
        ```
	2. Abre o **protonup-qt** e segue a captura de ecrã:
        <ImageComponent imgsrc={import('~/assets/images/steam-protonup.png')} />
        :::note
        Escolhe a versão `x86-64_v3` se o teu CPU suportar **[AVX2](/installation/installation_prepare#x86_64-microarchitecture-level-support)**.

        Caso contrário, descarrega a que termina em `x86-64`.
        :::
    3. Reinicia a Steam, caso a tenhas aberta.
    </Steps>
</TabItem>
