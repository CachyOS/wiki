...
1. Transfere o [ficheiro](https://mirror.cachyos.org/ISO/desktop/260628/cachyos-desktop-linux-260628.iso.sha256) que contém a hash SHA256 **(abre-o com um editor de texto, ex: Bloco de Notas)**.
...
1. Transfere o [ficheiro](https://mirror.cachyos.org/ISO/desktop/260628/cachyos-desktop-linux-260628.iso.sha256) que contém a hash SHA256.
...
2. Transfere o ficheiro ISO e o seu ficheiro de assinatura [.sig](https://cdn77.cachyos.org/ISO/desktop/260628/cachyos-desktop-linux-260628.iso.sig) e executa o seguinte comando (substitui `full_iso_name.iso` pelo nome real do ficheiro ISO):
   ```shell
