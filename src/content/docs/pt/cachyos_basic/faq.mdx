...
Útil para casos em que as entradas do carregador de arranque desapareçam após uma atualização da BIOS, ou simplesmente caso precise de o fazer.
...
- Abra o CachyOS Hello e navegue até **Troubleshooting**.
...
Se preferir uma interface gráfica, front-ends como o **[Shelly](</pt/configuration/post_install_setup/#atualizar-o-sistema>)** ou o **CachyOS Package Installer** são considerados alternativas seguras, pois funcionam como wrappers mais diretos para as funcionalidades do pacman.
