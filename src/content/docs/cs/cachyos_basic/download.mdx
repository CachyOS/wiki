...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/260124/cachyos-desktop-linux-260124.iso.sha256) obsahující SHA256 hash **(Otevřete jej v textovém editoru, např. Poznámkový blok).**
...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/260124/cachyos-desktop-linux-260124.iso.sha256) obsahující SHA256 hash.
