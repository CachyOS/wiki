...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/260308/cachyos-desktop-linux-260308.iso.sha256) obsahující SHA256 hash **(Otevřete jej v textovém editoru, např. Poznámkový blok).**
...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/260308/cachyos-desktop-linux-260308.iso.sha256) obsahující SHA256 hash.
