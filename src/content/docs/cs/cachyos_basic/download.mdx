...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/251129/cachyos-desktop-linux-251129.iso.sha256) obsahující SHA256 hash **(Otevřete jej v textovém editoru, např. Poznámkový blok).**
...
1.  Stáhněte [soubor](https://mirror.cachyos.org/ISO/desktop/251129/cachyos-desktop-linux-251129.iso.sha256) obsahující SHA256 hash.
