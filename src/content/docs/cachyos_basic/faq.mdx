...
For more information about Btrfs snapshots, please refer to the [Btrfs documentation.](https://btrfs.readthedocs.io/en/latest/)
...
<details>
<summary>Example in a screenshot:</summary>
...
<details>
    <summary>Screenshot of Btrfs Assistant:</summary>
