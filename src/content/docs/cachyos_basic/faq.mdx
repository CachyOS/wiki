...
:::note
In case of a deleted `/boot` partition. Please create a new one following the respective [partition scheme](/installation/installation_on_root#uefigpt) from step 5.
:::
