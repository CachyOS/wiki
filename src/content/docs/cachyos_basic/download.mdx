...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) containing the SHA256 hash **(Open it with a Text Editor e.g: Notepad).**
...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/250713/cachyos-desktop-linux-250713.iso.sha256) containing the SHA256 hash.
...
To verify the authenticity of the ISO file and make sure that it’s the actual one released by the official CachyOS development team:
