...
2. Download the ISO file and its [.sig](https://cdn77.cachyos.org/ISO/desktop/260308/cachyos-desktop-linux-260308.iso.sig) signature file and run the following command (replace `full_iso_name.iso` with the actual ISO filename):
   ```shell
