...
<Steps>
    1. Deaktiviere ZRam, indem du einen Kernel-Parameter hinzufügst. [Bearbeite deine Bootloader-Konfiguration](/de/configuration/boot_manager_configuration) und füge die folgende Zeile hinzu:
        ```text
        systemd.zram=0
        ```
    2. Aktiviere Zswap, indem du die folgenden Kernel-Parameter hinzufügst:
        ```text
        zswap.enabled=1 zswap.shrinker_enabled=1 zswap.compressor=lz4 zswap.max_pool_percent=30
        ```
    3. Erstelle eine Swap-Datei für Zswap.
        <details>
            <summary>Wenn du Btrfs verwendest:</summary>
                <Steps>
                    1. Erstelle ein Btrfs-Subvolume für die Swap-Datei:
                        ```bash
                        sudo btrfs subvolume create /swap
                        ```
                    2. Erstelle eine Swap-Datei mit der gewünschten Größe (z. B. 8 GB), indem du den `--size`-Parameter anpasst:
                        ```bash "--size"
        ...
        <details>
            <summary>Wenn du Btrfs nicht verwendest:</summary>
            <Steps>
                1. Erstelle eine Swap-Datei mit der gewünschten Größe (z. B. 8 GB), indem du den `count=`-Parameter anpasst:
                    ```bash "count=8"
    ...
    4. Baue dein Initramfs neu, um die Änderungen zu übernehmen. Der Befehl variiert je nach deinem Bootloader:
        <details>
    ...
    5. Starte dein System neu, um alle Änderungen zu übernehmen.
</Steps>
