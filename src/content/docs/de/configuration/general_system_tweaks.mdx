...
Unten findest du die 3 Betriebsmodi des `amd_pstate`-Treibers und die Kernel-Parameter, um sie beim Booten zu verwenden:

- AMD P-State (Nicht-autonomer Modus): `amd_pstate=passive`
- AMD P-State Guided (Geführter autonomer Modus): `amd_pstate=guided`
- AMD P-State EPP (Autonomer Modus): `amd_pstate=active`
