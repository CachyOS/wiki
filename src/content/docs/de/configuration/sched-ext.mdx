...
[Für einen genaueren Blick darauf, was diese Modi bei jedem Scheduler ändern](<https://github.com/sched-ext/scx/blob/main/tools/scx_loader/src/config.rs#L174>)
:::
