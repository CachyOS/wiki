...
- CPU & Sync-Performance
    - `PROTON_NO_NTSYNC=1`: FSync anstelle von NTSync verwenden.
        - **Vorteil**: Dieser Schalter dient dazu, Probleme in bestimmten Spielen zu beheben, die nicht gut mit NTSync harmonieren.
