...
Sie können es deaktivieren, indem Sie die Umgebungsvariable `PROTON_NO_NTSYNC=1` setzen
:::
...
- CPU- & Synchronisierungsleistung
    - `PROTON_NO_NTSYNC=1`: Verwendet FSync anstelle von NTSync.
        - **Vorteil**: Behebt möglicherweise Probleme in bestimmten Spielen, die nicht gut mit NTSync harmonieren.
