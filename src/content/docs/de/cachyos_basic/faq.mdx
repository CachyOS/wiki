...
:::note[Falls du eine /boot-Partition gelöscht hast, erstelle bitte eine neue, indem du dem entsprechenden [Partitionierungsschema](/de/installation/installation_on_root#uefigpt) ab Schritt 5 folgst.]
:::
