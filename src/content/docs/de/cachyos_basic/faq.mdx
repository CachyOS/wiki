...
:::note
Auch wenn CachyOS vor jedem System-Update automatisch Btrfs-Snapshots mit Pacman-Hooks erstellt, ist es immer eine gute Idee, eigene Snapshots zu erstellen, bevor du größere Änderungen am System vornimmst.
:::

Für mehr Infos zu Btrfs-Snapshots schau einfach in der [Btrfs-Dokumentation](https://btrfs.readthedocs.io/en/latest/) nach.
...
<details>
<summary>Beispiel als Screenshot:</summary>
...
<details>
    <summary>Screenshot vom Btrfs Assistant:</summary>
