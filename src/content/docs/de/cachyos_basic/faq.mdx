...
Vergiss nicht, den `tldr`-Befehl zu verwenden, um eine vereinfachte Version der Manpages für Befehle anzusehen, mit denen du nicht vertraut bist. Beispiel:
...
Nützlich, wenn die Bootloader-Einträge nach einem BIOS-Update verschwinden, oder einfach, falls es mal nötig sein sollte.
...
Wenn du eine grafische Oberfläche bevorzugst, gelten GUI-Frontends wie **[Shelly](</de/configuration/post_install_setup/#das-system-aktualisieren>)** oder der **CachyOS Package Installer** als sichere Alternativen, da sie direktere Wrapper für die Pacman-Funktionalität sind.
