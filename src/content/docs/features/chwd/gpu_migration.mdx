...
<Tabs>
    <TabItem label='From NVIDIA to AMD'>
        ...
        <Steps>
            0. Make note of your account's username and password. You may need it for a login via TTY.
            ...
            3. Shutdown your system and proceed to install your AMD GPU.
                > If after installing the GPU the system loads into a black screen press, then CTRL+ALT+F3 to enter TTY.
                > Enter your username and password (mind NUMLOCK).
