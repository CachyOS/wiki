...
4. Run `cachy-chroot` by typing:
    ...
    <Tabs>
        <TabItem label='Example output with CachyOS BTRFS install'>
            ```bash
        ...
        <TabItem label='Example output with EXT4'>
            ```bash
...
5. Select the partition that contains the root filesystem:
    <Tabs>
        <TabItem label='Example with CachyOS BTRFS'>
        ...
        <TabItem label='Example with EXT4'>
            ```bash title="Selecting root partition"
